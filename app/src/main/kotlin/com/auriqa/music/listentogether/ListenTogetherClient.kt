...
import com.auriqo.music.constants.ListenTogetherAutoApprovalKey
import com.auriqo.music.constants.ListenTogetherIsHostKey
import com.auriqo.music.constants.ListenTogetherRoomCodeKey
import com.auriqo.music.constants.ListenTogetherServerUrlKey
import com.auriqo.music.constants.ListenTogetherSessionTimestampKey
import com.auriqo.music.constants.ListenTogetherSessionTokenKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.auriqo.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.auriqo.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.auriqo.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.auriqo.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.auriqo.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
